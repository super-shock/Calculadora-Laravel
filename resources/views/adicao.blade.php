...
.botao, select, label.checkbox {
    ...
    <!-- <div class="container">
        ...
        <div class="title">Adição:</div><br>
        <script>
            var adi1=prompt("Digite o primeiro número");
            var adi2=prompt("Digite o segundo número");

            var adicao=parseInt(adi1)+parseInt(adi2);

            document.write(" A adição dos números é : " + adicao + "");
        </script>
