...
.botao, select, label.checkbox {
    ...
    <!-- <div class="container">
        ...
        <div class="title">Multiplicação:</div><br>
        <script>
            var multi1=prompt("Digite o primeiro número");
            var multi2=prompt("Digite o segundo número");

            var multiplicacao=parseInt(multi1)*parseInt(multi2);

            document.write(" A multiplicação dos números é : " + multiplicacao + "");
        </script>
