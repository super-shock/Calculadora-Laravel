...
.botao, select, label.checkbox {
    ...
    <!-- <div class="container">
        ...
        <div class="title">Subtração:</div><br>
        <script>
            var sub1=prompt("Digite o primeiro número");
            var sub2=prompt("Digite o segundo número");

            var subtracao=parseInt(sub1)-parseInt(sub2);

            document.write(" A subtração dos números é : " + subtracao + "");
        </script>
